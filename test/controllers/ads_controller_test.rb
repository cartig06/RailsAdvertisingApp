...
class AdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ad" do
    assert_difference('Ad.count') do
      post ads_url, params: { ad: { company: @ad.company, description: @ad.description, name: @ad.name } }
    end
  ...
  test "should update ad" do
    patch ad_url(@ad), params: { ad: { company: @ad.company, description: @ad.description, name: @ad.name } }
